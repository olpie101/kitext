...
//func (c *transport) wrap(payload []byte) (*Msg, error) {
//	var (
//		pb  []byte
//		err error
//	)
...
//func (c *transport) unwrap(nmsg *nats.Msg) (*Msg, error) {
//	var msg Message
//
...
//func (c *transport) Publish(ctx context.Context, sub string, data []byte, opts ...PublishOption) (*Msg, error) {
...
//func (c *transport) Request(sub string, req proto.Message, data []byte, opts ...RequestOption) (*Msg, error) {
...
//	//replyWithError := func(logger *zap.Logger, msg *Msg, sts *status.Status) {
//	//	rmsg, err := c.wrap(nil)
